...
export class ResultBox extends React.Component{
	...
	render(){
		return (
			<div>
			<li tabIndex={this.props.number} onClick={this.handleClick(this.props.item, this.props.number)} onKeyPress={this.handleKeyPress(this.props.item, this.props.number)}>
